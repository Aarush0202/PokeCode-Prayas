...
def _extract_zone_id(text: str) -> Optional[str]:
    ...
    aliases = [
        # Delhi venues
        ("chandni chowk", "ch01"),
        ("connaught place", "ch02"),
        ("cp inner circle", "ch02"),
        ("lajpat nagar", "ch03"),
        ("kashmere gate", "dl04"),
        ("isbt kashmere gate", "dl04"),
        ("paranthe wali gali", "dl05"),
        ("sarojini nagar", "dl06"),
        ("jama masjid", "dl07"),
        ("delhi university", "dl08"),
        ("du north campus", "dl08"),
        # Gurugram venues
        ("cyber hub", "gg01"),
        ("leisure valley", "gg02"),
        ("sheetla mata", "gg03"),
        ...
        ("isbt 43", "cd02"),
        ("isbt sector 43", "cd02"),
        ("bus terminal 43", "cd02"),
        ("elante", "cd03"),
        ("sukhna lake", "cd05"),
        ("sukhna", "cd05"),
        ("lake", "cd05"),
        ("panjab university", "cd06"),
        ("student centre", "cd06"),
        ("stuc", "cd06"),
        # Mohali venues
        ("phase 3b2", "mo01"),
